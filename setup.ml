...
(* OASIS_START *)
(* DO NOT EDIT (digest: 4ac37df08ede1d2c24e16c421cf827b8) *)
(*
...
let setup_t =
  {
       ...
       [
          ...
          ("test_merge",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_merge", ["-q"]))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              })
       ];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Merge_rope"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "merge-ropes";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "ropes.ml"});
               Executable
                 ({
                     cs_name = "test_merge";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "merge_ropes.ml"});
               Test
                 ({
                     cs_name = "test";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "H\165\222\177\023\004\206\130!\001*-\145\253k\000";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
