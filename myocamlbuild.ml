(* OASIS_START *)
(* DO NOT EDIT (digest: e08d9424528d5677de6b8ca871d45ada) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml = [("merge-ropes", ["lib"], [])];
     lib_c = [];
     flags =
       [
          (["oasis_library_merge_ropes_byte"; "ocaml"; "link"; "byte"],
            [(OASISExpr.EBool true, S [A "-bin-annot"])]);
          (["oasis_library_merge_ropes_native"; "ocaml"; "link"; "native"],
            [(OASISExpr.EBool true, S [A "-bin-annot"])]);
          (["oasis_library_merge_ropes_byte"; "ocaml"; "ocamldep"; "byte"],
            [(OASISExpr.EBool true, S [A "-bin-annot"])]);
          (["oasis_library_merge_ropes_native"; "ocaml"; "ocamldep"; "native"
           ],
            [(OASISExpr.EBool true, S [A "-bin-annot"])]);
          (["oasis_library_merge_ropes_byte"; "ocaml"; "compile"; "byte"],
            [(OASISExpr.EBool true, S [A "-bin-annot"])]);
          (["oasis_library_merge_ropes_native"; "ocaml"; "compile"; "native"],
            [(OASISExpr.EBool true, S [A "-bin-annot"])])
       ];
